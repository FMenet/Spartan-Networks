...
def prep_bbox(sess, x, y, X_train, Y_train, X_test, Y_test,
    ...
    kerasmodel = spartan_network(sess=sess, train=True, w=1)
...
if __name__ == '__main__':
    ...
    flags.DEFINE_float('epsilon', 0.3, 'power of attack, by default 0.3')
